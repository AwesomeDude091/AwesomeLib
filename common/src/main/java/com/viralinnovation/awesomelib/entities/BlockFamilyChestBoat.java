...
public class BlockFamilyChestBoat extends BlockFamilyBoat implements HasCustomInventoryScreen, ContainerEntity {
    private NonNullList<ItemStack> itemStacks = NonNullList.withSize(27, ItemStack.EMPTY);
    @Nullable
    private ResourceLocation lootTable;
    private long lootTableSeed;

    public BlockFamilyChestBoat(RegistrationContext context, EntityType<? extends BlockFamilyBoat> p_219869_, Level p_219870_) {
        super(context, p_219869_, p_219870_);
    }

    public BlockFamilyChestBoat(RegistrationContext context, Level p_219872_, double p_219873_, double p_219874_, double p_219875_) {
        this(context, context.getChestBoatEntityType().get(), p_219872_);
    ...
    public Item getDropItem() {
        return this.getAwesomeBoatType().getItem(Variants.CHEST_BOAT.getClazz()).get();
    }
